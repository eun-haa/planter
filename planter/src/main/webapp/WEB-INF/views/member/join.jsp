	                    ...
	                    <div class="agreeArea_wrap">
	                        <ul class="left">
	                            <div class="agreeArea">  
	                                ...
	                                <p class="check"><span>이용약관에 동의하십니까?</span> <label for="agree_service_check0" class="agree_service_lable"><input id="agree_service_check0" name="agree_check" type="checkbox">동의함</label></p>
	                            </div>
	                        </ul>
	                        ...
	                        <ul class="right">
	                            ...
	                            <div class="agree">
	                                ...
	                                <p class="check"><span>개인정보 수집 및 이용에 동의하십니까?</span> <label for="agree_privacy_check0"><input id="agree_privacy_check0" name="agree_check" type="checkbox">동의함</label></p>
	                            </div>
	                        </ul>
	                    </div>
